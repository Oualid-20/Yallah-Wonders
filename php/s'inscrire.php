...
?>
    <link rel="stylesheet" href="../assets/css/s'inscrire.css">
    ...
    <div class="ecran-divise">
        ...
        <div class="section-droite">
            <div class="illustration">
                <img src="../assets/img/s'inscrire.png" alt="illustrateur">
            </div>
            ...
            <button class="bouton-login"><a href="connecter_clt.php">SE CONNECTER</a></button>
        </div>
    </div>
